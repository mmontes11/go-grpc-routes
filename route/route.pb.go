...
var file_route_proto_rawDesc = []byte{
	...
	0x32, 0xd7, 0x01, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x2c, 0x0a, 0x0a, 0x47, 0x65,
	...
	,
}
...
var file_route_proto_depIdxs = []int32{
	...
	2, // 5: route.Route.ListFeatues:input_type -> route.Rectangle
	...
	1, // 9: route.Route.ListFeatues:output_type -> route.Feature
...
type RouteClient interface {
	...
	ListFeatues(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (Route_ListFeatuesClient, error)
...
func (c *routeClient) ListFeatues(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (Route_ListFeatuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Route_serviceDesc.Streams[0], "/route.Route/ListFeatues", opts...)
	if err != nil {
		return nil, err
	}
	x := &routeListFeatuesClient{stream}
...
type Route_ListFeatuesClient interface {
	Recv() (*Feature, error)
	grpc.ClientStream
}

type routeListFeatuesClient struct {
	grpc.ClientStream
}

func (x *routeListFeatuesClient) Recv() (*Feature, error) {
	m := new(Feature)
...
type RouteServer interface {
	...
	ListFeatues(*Rectangle, Route_ListFeatuesServer) error
...
func (*UnimplementedRouteServer) ListFeatues(*Rectangle, Route_ListFeatuesServer) error {
	return status.Errorf(codes.Unimplemented, "method ListFeatues not implemented")
}
...
func _Route_ListFeatues_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Rectangle)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RouteServer).ListFeatues(m, &routeListFeatuesServer{stream})
}

type Route_ListFeatuesServer interface {
	Send(*Feature) error
	grpc.ServerStream
}

type routeListFeatuesServer struct {
	grpc.ServerStream
}

func (x *routeListFeatuesServer) Send(m *Feature) error {
...
var _Route_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "ListFeatues",
			Handler:       _Route_ListFeatues_Handler,
			ServerStreams: true,
		},
		{
